...
class Setup {
	...
	public function __construct() {
		...
		if ( class_exists( 'WooCommerce' ) ) {
			add_action( 'woocommerce_add_to_cart_fragments', [ $this, 'gardenar_add_to_cart_number' ] );
		}
	}
	...
	public function setup() {
		load_theme_textdomain( 'gardenar', get_template_directory() . '/languages' );
	...
	private function add_image_size() {
		$sizes = [
			'gardenar-size1' => [ 1344, 625, true ],
			'gardenar-size2'  => [ 960, 520, true ],
			'gardenar-size3'  => [ 960, 690, true ],
			'gardenar-size4'  => [ 450, 450, true ],
			'gardenar-size5'  => [ 600, 682, true ],
			'gardenar-size6'  => [ 960, 960, true ],
			'gardenar-size7'  => [ 450, 600, true ],
		];

		$sizes = apply_filters( 'gardenar_image_size', $sizes );

...
class ProjectRelated {
	public static function rt_project_related() {
		...
		$title_length = gardenar_option( 'rt_project_related_title_limit' ) ? gardenar_option( 'rt_project_related_title_limit' ) : '';
		$related_item_number = gardenar_option( 'rt_project_related_limit' );
		...
		$query_type = gardenar_option( 'rt_project_related_query' );
		...
		if( gardenar_option( 'rt_project_related_sort' ) ){

			$post_order = gardenar_option( 'rt_project_related_sort' );
		...
		if( $related_query->have_posts() && gardenar_option( 'rt_project_related' ) ) { ?>
			<div class="rt-project-default rt-project-multi-layout-default rt-related-project">
				<div class="container">
					<h2 class="related-title"><?php gardenar_html( gardenar_option( 'rt_project_related_title' ) , 'allow_title' );?></h2>
					<div class="row g-4">
								...
								<div class="project-item">
									...
									<div class="project-content">
										...
										<?php if( gardenar_option( 'rt_project_ar_button' ) ) { ?>
											<div class="rt-button">
												<a class="btn button-1" href="<?php the_permalink();?>"><i class="icon-rt-right-arrow-2"></i></a>
											</div>
										<?php } ?>
									</div>
								</div>

...
class TeamRelated {
	public static function rt_team_related() {
		...
		$related_item_number = gardenar_option( 'rt_team_related_limit' );

		# Making ready to the Query ...
		$query_type = gardenar_option( 'rt_team_related_query' );
		...
		if( gardenar_option( 'rt_team_related_sort' ) ){

			$post_order = gardenar_option( 'rt_team_related_sort' );
		...
		if( $related_query->have_posts() && gardenar_option( 'rt_team_related' ) ) { ?>
			<div class="rt-team-default rt-team-multi-layout-1 rt-related-team">
				<div class="container">
					<h2 class="related-title"><?php gardenar_html( gardenar_option( 'rt_team_related_title' ) , 'allow_title' );?></h2>
					<div class="row g-4">

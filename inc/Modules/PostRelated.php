...
class PostRelated {
	...
	public static function rt_post_related() {
		...
		$related_item_number = gardenar_option( 'rt_post_related_limit' );

		# Making ready to the Query ...
		$query_type = gardenar_option( 'rt_post_related_query' );
		...
		if( gardenar_option( 'rt_post_related_sort' ) ){

			$post_order = gardenar_option( 'rt_post_related_sort' );
		...
		if( $related_query->have_posts() && gardenar_option( 'rt_post_related' ) ) { ?>
			<div class="blog-default rt-related-post">
				<div class="container">
					<h2 class="related-title"><?php gardenar_html( gardenar_option( 'rt_post_related_title' ) , 'allow_title' );?></h2>
					<div class="row">
						...
						<div class="col-sm-6 col-xl-4 col-lg-4" >
							<article data-post-id="<?php the_ID(); ?>" <?php post_class( gardenar_post_class() ); ?>>
								<div class="article-inner-wrapper">
									...
									<?php gardenar_post_thumbnail('gardenar-size3'); ?>
									...
									<div class="entry-wrapper">
										<header class="entry-related-header">
											...
											gardenar_separate_meta( 'title-above-meta' );

...
class Hooks {
	...
	public function __construct() {
		...
		add_action( 'gardenar_before_single_content', [ __CLASS__, 'before_single_content' ] );
		add_action( 'wp_head', [ __CLASS__, 'wp_footer_hook' ] );

		add_action('bcn_after_fill', [ __CLASS__, 'gardenar_hseparator_breadcrumb_trail' ] );
	...
	public static function wp_footer_hook() {
		?>
		<style>
			.gardenar-header-footer .site-header {
				opacity: 1;
			}
		</style>
	...
	public static function before_single_content() {
		...
		if ( in_array( $style, [ '2', '3', '4' ] ) ) {
			...
			<div class="<?php echo esc_attr( $classes ) ?>">
				...
				<?php if ( $style == '3' ) : ?>
					<div class='single-top-header <?php echo esc_attr( gardenar_post_class( null ) ) ?>'>
						<div class='container'>
							<div class="row">
	...
	public static function gardenar_hseparator_breadcrumb_trail($object){
		$object->opt['hseparator'] = '<span class="dvdr"><i class="icon-rt-right-arrow-2"></i></span>';
		return $object;
	}

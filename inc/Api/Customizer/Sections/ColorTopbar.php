...
class ColorTopbar extends Customizer {
	...
	public function register() {
		Customize::add_section( [
			...
			'title'       => __( 'Top Bar Colors', 'gardenar' ),
			'description' => __( 'Top Bar Color Section', 'gardenar' ),
			'priority'    => 3
		] );
	...
	public function get_controls() {
		...
		return apply_filters( 'rt_header_color_controls', [
			...
			'rt_topbar_color' => [
				'type'  => 'alfa_color',
				'label' => __( 'Topbar Color', 'gardenar' ),
			],

			'rt_topbar_active_color' => [
				'type'  => 'alfa_color',
				'label' => __( 'Hover Color', 'gardenar' ),
			],

			'rt_topbar_bg_color' => [
				'type'  => 'alfa_color',
				'label' => __( 'Topbar Background', 'gardenar' ),
			],

...
<!-- preloader -->
<?php if ( gardenar_option( 'rt_preloader' ) ) {
	if( !empty( gardenar_option( 'rt_preloader_logo' ) ) ) { ?>
		<div id="preloader"><?php echo wp_get_attachment_image( gardenar_option( 'rt_preloader_logo' ), 'full', true );?></div>
	<?php } else { ?>
	...
	<div id="header-search" class="header-search">
		<div class="header-search-wrap">
			...
			<form method="get" class="header-search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
				<input type="search" value="<?php echo get_search_query(); ?>" name="s" placeholder="<?php esc_attr_e( 'Type your search........', 'gardenar' ); ?>">

		...
		<div class="service-content">
			<div class="service-info">
				<?php if (!empty( $rt_service_icon )  ) { ?>
					<div class="service-icon" <?php echo wp_specialchars_decode( esc_attr( $service_bg ), ENT_COMPAT ); ?>><i class="<?php gardenar_html( $rt_service_icon , false );?>"></i></div>
				<?php } ?>
			...
			<?php if ( gardenar_option( 'rt_service_read_more' ) ) { ?>
				<div class="rt-button">
					<a class="btn button-3" href="<?php the_permalink();?>">
						<?php esc_html_e('See Details' , 'gardenar' ); ?><i class="icon-rt-right-arrow"></i>
					</a>
				</div>
			<?php } ?>
		</div>
